...
evaluator.biological.anotate.list <- function( gene_list, debug = FALSE ) {
  ...
  #tests$PValue
  #tests$Count
  # y tests$X. que posiblemente es el % que aparece en la pÃ¡gina al usar functional annotation chart
  
  # Falta agregar mÃ¡s categorÃ­as a este anÃ¡lisis. ProbÃ© agregando todas pero crashea
