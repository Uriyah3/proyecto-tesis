...
#' Note: The GPL files where downloaded from CuMiDa
#' 
#' @param filename The path to the file
#' @return A matrix with the information stored in \code{filename}
#' @examples
#' gpl_data = read.gpl("data/chip_to_entrez_id/GPL96-57554.txt")
#' 
...
gpl_to_file <- list(
  GPL96 = "data/chip_to_entrez_id/GPL96_limpo.txt",
  GPL3921 = "data/chip_to_entrez_id/GPL3921_limpo.txt",
  GPL570 = "data/chip_to_entrez_id/GPL570_limpo.txt",
  GPL13607 = "data/chip_to_entrez_id/GPL13607_limpo.txt",
  GPL13667 = "data/chip_to_entrez_id/GPL13667_limpo.txt"
)
